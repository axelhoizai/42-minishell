...
LEXING = lexing/input_lexer.c lexing/lexer_parser.c lexing/lexer_expand.c lexing/utils_lexer_expand.c \
			lexing/lexer_expand_wildcard.c

PARSING = 	parsing/token_parser.c  \
			parsing/pip_free.c parsing/pip_init.c parsing/pip_parser.c parsing/pip_redir.c
...
EXEC = 	execution/pipex.c execution/utils_exec.c execution/utils_error.c \
		...
		execution/pipe_first.c execution/pipe_multi.c execution/utils_check.c
