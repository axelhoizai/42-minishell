...
EXEC = 	execution/pipex.c execution/utils_exec.c execution/utils_error.c \
		...
		execution/pipe_first.c execution/pipe_multi.c execution/utils_wildcard.c execution/utils_check.c

PARSING = 	parsing/argv_parser.c parsing/token_parser.c parsing/utils_token.c parsing/quote_parser.c \
